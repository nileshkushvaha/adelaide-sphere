...
export interface paths {
    ...
    "/api/v1/areas": {
        ...
        /** Approved, active Adelaide local areas */
    ...
    "/api/v1/admin/businesses/{id}/hours": {
        ...
        /** Operating hours (Australia/Adelaide wall clock) with the status evaluated now */
    ...
    "/api/v1/admin/posts/{id}/schedule": {
        ...
        get?: never;
        put?: never;
        /** Schedule publication at a UTC instant chosen as Adelaide time */
    ...
    "/api/v1/admin/comments/{id}/reply": {
        ...
        get?: never;
        put?: never;
        /** Reply as the Adelaide Sphere team; published at once and recorded */
    ...
    "/api/v1/site/context": {
        ...
        /** Fixed Adelaide context: city, state, country, timezone */
...
export interface components {
    schemas: {
        ...
        AddressInputDto: {
            ...
            suburb: string;
            /** @description South Australian postcode (5xxx) */
            postcode: string;
        ...
        CreateBusinessDto: {
            ...
            ogImageMediaId?: string | null;
            /** @description How Adelaide eligibility was verified; saving it records the verification time */
            eligibilitySource?: string | null;
        ...
        HoursDto: {
            ...
            /** @description Evaluated at the time of the request (Australia/Adelaide) */
        ...
        AuthorInputDto: {
            ...
            bio?: string | null;
            pronouns?: string | null;
            /** @description Adelaide suburb or area the author writes from */
            location?: string | null;
        ...
        SchedulePostDto: {
            ...
            /**
             * Format: date-time
             * @description UTC instant; the admin picks Australia/Adelaide time (SRS BLOG 002)
             */
            scheduledAt: string;
        };
        PublicTermRefDto: {
        ...
        PublicCommentDto: {
            ...
            parentId: string | null;
            /** @description Written by the Adelaide Sphere team */
            staff: boolean;
        ...
        DashboardTrendSeriesDto: {
            ...
            href: string;
            /** @description Submissions per Adelaide calendar day, aligned with `days` */
            points: number[];
        ...
        DashboardTrendDto: {
            /** @description Adelaide calendar days (YYYY-MM-DD), oldest first */
            days: string[];
        ...
        PublicSiteMapDto: {
            /** @description A validated Google Maps embed address, or the built-in Adelaide map */
            src: string;
            title: string;
        };
        PricingPlanDto: {
        ...
        GeneralSettingsRecordDto: {
            ...
            /** @description Google Maps "Embed a map" HTML or address for the map above the footer; empty shows Adelaide */
        ...
        ScheduleStaticPageDto: {
            ...
            /**
             * Format: date-time
             * @description UTC instant; the admin picks Australia/Adelaide time. Must be in the future.
             */
            scheduledAt: string;
        };
    ...
    DirectoryPublicController_list: {
        parameters: {
            query?: {
                ...
                minRating?: number;
                /** @description Only listings open at the moment of the request, in Adelaide time (SRS DIR 008). Conditional: ignored while published hours coverage is below the threshold, which `meta.openNow.available` reports. Listings without published hours are never included — an absent schedule is not evidence of being open. */
                openNow?: boolean;
