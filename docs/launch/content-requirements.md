...
| --- | --- | --- | --- | --- | --- | --- |
| About | `/about` | Who runs the site, what "Adelaide" means (see D01), how listings are verified, how to get in touch | 300–800 words | One H1 (the page title); headings in order; plain language | Page absent from navigation and footer (no 404 is linked) | Pending |
...
| Browser icon | Browser tab, bookmarks | Square PNG, at least 512×512 px; simple shape that survives 16 px | Not announced; decorative | The globe mark: `brand-favicon.png` 96×96 (the one declared icon), `apple-touch-icon.png` 180×180, `favicon.ico` 16/32/48 px, all from the same 512 px master (`brand-logo.png`, also the Organization logo when none is uploaded). A favicon set in General settings replaces the declared icon | Pending |
...
| Hero photographs (up to 6) | Homepage banner behind the headline and search | Landscape JPEG or WebP, at least 2560×1440 px, under 10 MB; Adelaide subjects; avoid busy detail behind the headline area (a navy wash is applied). Each slide takes a focal point and a caption of up to 120 characters | Alt text per slide (what is pictured); the credit line goes in the caption when a licence requires attribution | Two Creative Commons (CC BY-SA) photographs with attribution rendered on the banner; the client may approve these as launch assets (the licence permits commercial use with credit and share-alike terms) | Pending |
| Rotating headline phrases | Homepage hero | 2–5 short phrases, each under 40 characters, that complete "Discover Adelaide businesses: …" | Announced once as a single sentence to assistive technology, whatever the animation does | "local services", "places to eat", "independent shops" (SRS HERO 002's own example wording) | Pending |
...
| --- | --- | --- |
| Application name and tagline (General settings) | "Adelaide Sphere" / "Find local businesses across Adelaide" | Tagline under 60 characters; appears in the browser title |
| Default meta description (General settings) | "An independent directory of businesses across Adelaide, South Australia: cafes, trades, services and more, with opening hours and contact details." | 120–155 characters |
| Hero headline (Site settings) | "Discover Adelaide businesses" | Under 80 characters; one H1 |
| Home — categories band | "Start with a category" / "Every category is curated by our editors and lists only published Adelaide businesses." | Heading under 40 characters; description under 140 |
| Home — featured band | "Featured Adelaide businesses" / "A small, clearly labelled set of placements. They never displace organic results." | Same |
| Home — recently added | "New on Adelaide Sphere" / "The newest listings our editors have verified and published." | Same |
| Home — highly rated | "Highly rated in Adelaide" / "Averages come from approved reviews only." | Same |
| Home — areas band | "Find businesses by local area" / "We cover Adelaide only — the CBD and the suburbs around it — so an area page is a real neighbourhood, not a generated location page." | Must stay consistent with decision D01 |
| Home — blog band | "From the Adelaide Sphere blog" / "Local guides and stories written by our editors." | |
| Home — how it works | "No account needed — There are no business logins in Adelaide Sphere. You email us; we do the rest." / "Checked before publishing — Our editors verify the details and the Adelaide location before a listing goes live." / "Adelaide only — We cover one city properly instead of thousands of generated location pages." | Three items, each title under 30 characters and body under 120 |
