...
| Browser icon | Browser tab, bookmarks | Square PNG, at least 512×512 px; simple shape that survives 16 px | Not announced; decorative | The globe icon (`apps/web/public/favicon.ico`, 16/32/48 px), replaced automatically when a favicon is set in General settings | Pending |
