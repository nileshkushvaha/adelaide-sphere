...
const TONES: Record<string, { tone: Tone; label?: string }> = {
  requested: { tone: 'progress' },
  stored: { tone: 'attention', label: 'awaiting review' },
  superseded: { tone: 'neutral', label: 'replaced' },
  researching: { tone: 'progress' },
  generating: { tone: 'progress' },
  needs_fact_review: { tone: 'attention', label: 'needs fact review' },
  ready_for_review: { tone: 'attention', label: 'ready for review' },
  outcome_unknown: { tone: 'critical', label: 'outcome unknown' },
  cancelled: { tone: 'neutral' },
  verified: { tone: 'positive' },
  unresolved: { tone: 'attention' },
  conflicting: { tone: 'critical' },
  stale: { tone: 'attention' },
  excluded: { tone: 'neutral' },
  proposed: { tone: 'attention' },
  filled: { tone: 'positive', label: 'research started' },
  missed: { tone: 'attention' },
  reviewed: { tone: 'neutral' },
  duplicate: { tone: 'critical' },
  review: { tone: 'attention', label: 'review needed' },
