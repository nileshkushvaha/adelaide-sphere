...
export class PublicPostDto extends PublicPostCardDto {
  ...
  @ApiPropertyOptional({ type: String, nullable: true, description: 'Disclosure shown under an AI-generated featured image (for example "Illustrative image created with AI."). Absent for photographs and uploaded images.' })
