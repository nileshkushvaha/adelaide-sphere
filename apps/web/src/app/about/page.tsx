...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return routeMetadata(
    ...
    await pageMetadata({
      ...
      path: '/about',
      keywords: [`about ${name}`, 'Adelaide business directory', 'independent local directory', 'how listings are checked', 'Adelaide South Australia'],
    ...
    <article className="ms-product-page">
      ...
      <ProductPageLayout
          ...
          <>
            ...
            <section aria-labelledby="who-heading" className="ms-content-panel">
              ...
              <div className="mt-3 flex max-w-2xl flex-col gap-4 leading-relaxed text-text-muted sm:text-lg sm:leading-relaxed">
                <p>
                  {settings.name} is a local directory for Adelaide, South Australia. It brings the city’s cafés, trades, clinics, shops and services together in one place, alongside guides to the suburbs they sit in and stories about the city around them.
                </p>
                <p>
        ...
        aside={
          ...
          <AsideCard id="mission-heading" sticky={false} icon={SparklesIcon} title="Our mission" description="To make Adelaide’s local businesses easier to find and easier to trust — one checked listing at a time.">
